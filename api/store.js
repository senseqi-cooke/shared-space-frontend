 ...
 * @returns {*}
 */
export function geStoreDetail(storeId) {
 ...
 * @returns {*}
 */
export function geStoreRoomDetail(paramData) {
  return request.post("/storeoom/detail", paramData, {
    login: false,
  });
}
 ...
 * @returns {*}
 */
export function getStoreRoomPackage(paramData) {
  return request.get("/mtStoreRoomPackage", paramData);
}
 ...
 * @returns {*}
 */
export function getStoreRoomPackageDetail(id) {
  return request.get(`/mtStoreRoomPackage/${id}`);
}
