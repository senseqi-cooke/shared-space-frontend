...
export function userInfor(data) {
  return request.get("/userInfor", data, {
...
export function updateUserAvatar(data) {
  return request.post("/updateUserAvatar", data, {
    login: true,
  });
}
...
export function updateUserNickname(data) {
  return request.post("/updateUserNickname", data, {
    login: true,
  });
}
...
export function getUserStat(data) {
  return request.get("/getUserStat", data, {
    // return request.get("/citys", data, {
    login: true,
  });
}

export function getStoreBalanceList(data) {
  return request.post("/user/storeBalanceList", data, {
    login: true,
  });
}
...
export function getUserBalance(data) {
  return request.get("/user/getUserBalance", data, {
    login: true,
  });
}
...
export function getUserBillList(data) {
  return request.get("/user/getUserBillList", data, {
    login: true,
  });
}
 ...
 * 根据用户Id,获取用户会员等级
 */
export function getUserGradeByUserId(data) {
  return request.post("/userGrade/getUserGradeByUserId", data, {
    login: true,
  });
}
 ...
 * 小程序绑定openid
 * */
export function wxappBindOpenid(data) {
  return request.post("/wxapp/updateOpenid", data, {
    login: true,
  });
}
...
export function extractCommission(data) {
  return request.post("/user/extractCommission", data, {
    login: true,
  });
}
...
// 生成小程序二维码，会携带用户的id作为邀请链接
export function getSiteQrCode(data) {
  return request.get("/spread/qrcode", data);
}
...
export function subscribeOrderEndMessage() {
  // 调用订阅
  console.log("调用订阅");
...
// 获取我的商家统计
export function getMyStoreCount(data) {
  return request.get("/user/getMyStoreCount", data, {
    login: true,
  });
}

// 获取我的加盟商
export function getMyFranchisee(data) {
  return request.get("/franchisee/list", data, {
    login: true,
  });
}

// 获取我的联创
export function getMyCofounder(data) {
  return request.get("/cofounder/list", data, {
    login: true,
  });
}
