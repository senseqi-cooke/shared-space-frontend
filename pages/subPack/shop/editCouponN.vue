	...
	<view class="formBox">
		...
		<view class="inputBox">
			...
			<u--input
			    ...
			    border="bottom"
				placeholderClass="joinPla" v-model="useableCount" required></u--input>
		</view>
		<view class="inputBox">
			<view class="title">
				<text>*</text>每次可使用小时数
			...
			<u--input
			    placeholder="请输入每次可使用小时数"
			    border="bottom"
				placeholderClass="joinPla" v-model="everyUseableHourCount" required></u--input>
		</view>		
		...
		<view class="inputBox">
			...
			<u--input
			    ...
			    border="bottom"
				placeholderClass="joinPla" v-model="limitDay" required></u--input>
		</view>
		<view class="inputBox">
			<view class="title">
				<text>*</text>每个用户限购次数
