<template>
  <view class="distributionBox">
    <view class="navBox">
      <view
        :class="[navSelect == 0 ? 'selectNav' : '', 'nav']"
        @click="setNavSelect(0)"
      >
        全部
        <view class="icon"></view>
      </view>
      <view
        :class="[navSelect == 1 ? 'selectNav' : '', 'nav']"
        @click="setNavSelect(1)"
      >
        待使用
        <view class="icon"></view>
      </view>
      <view
        :class="[navSelect == 2 ? 'selectNav' : '', 'nav']"
        @click="setNavSelect(2)"
      >
        服务中
        <view class="icon"></view>
      </view>
      <view
        :class="[navSelect == 3 ? 'selectNav' : '', 'nav']"
        @click="setNavSelect(4)"
      >
        已完成
        <view class="icon"></view>
      </view>
