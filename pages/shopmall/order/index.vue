          ...
          >
            ...
            >
              ...
              <view class="goods-content">
                ...
                <!-- 服务 -->
                <view class="goods-props clearfix" v-show="goods.additionalList && goods.additionalList.length">
                  已选服务:
  ...
  methods: {
    ...
    getOrderList(pageNo = 1) {
      ...
      return new Promise((resolve, reject) => {
        OrderApi.list(
          { dataType: app.getTabValue(), page: pageNo, type: "goods" },
          { load: false }
        ).then((result) => {
          // 合并新数据
    ...
    handleTargetDetail(orderId) {
      this.$navTo("pages/shopmall/order/detail", { orderId });
    },
  },
};
</script>
...
.container,
input {
  font-family: PingFang-Medium, PingFangSC-Regular, Heiti, Heiti SC, DroidSans,
    DroidSansFallback, "Microsoft YaHei", sans-serif;
