...
function getAuthUrl(appId) {
  ...
  //const redirect_uri = encodeURIComponent(`${location.origin}/pages/Loading/index`)
  // const redirect_uri = encodeURIComponent(`${location.origin}/pages/homePage/homePage`)
  const redirect_uri = encodeURIComponent(`${location.origin}/pages/homePage_V2/homePage_V2`)
