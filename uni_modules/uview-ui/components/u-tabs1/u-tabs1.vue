                ...
                <view class="u-scroll-box" :class="{'u-tabs-scorll-flex': !isScroll}">
                    <view class="u-tab-item u-line-1" :id="'u-tab-item-' + index" v-for="(item, index) in list" :key="index" @tap="clickTab(index)"
                     :style="[tabItemStyle(index)]">
                        <u-badge1 :count="item[count] || item['count'] || 0" :offset="offset" size="mini"></u-badge1>
                        {{ item[name] || item['name']}}
                    </view>
    ...
    export default {
        ...
        methods: {
            ...
            getTabRect() {
                ...
                query.exec(
                    function(res) {
						console.log("this.tabQueryInfo-res:"+res);
            ...
            scrollByIndex() {
				...
				//console.log("this.tabQueryInfo[this.currentIndex]:"+this.tabQueryInfo[this.currentIndex]);
				console.log("scrollByIndex-currentIndex:"+this.currentIndex);
